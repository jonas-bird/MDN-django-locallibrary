...
class Genre(models.Model):
    ...
    name = models.CharField(
        max_length=200,
        unique=True,
        help_text="Enter a book genre (e.g. Science Fiction, History, Babylonian Epic Poetry etc..,)"
    )

    def __str__(self):
        """String representaitons of the Genre objects"""
        return self.name
...
class Book(models.Model):
    ...
    # Foreign Key is used because for this model a book only has a single
    # author, but an author can have multiple books
    summary = models.TextField(
        max_length=1000, help_text="Enter a brief desciption of book")
